...
var Item = function () {
  function Item() {
    var type = arguments.length <= 0 || arguments[0] === undefined ? CalcTypes.ADD : arguments[0];
    var numMax = arguments.length <= 1 || arguments[1] === undefined ? 10 : arguments[1];
    ...
    if (type === CalcTypes.ALL) {
      var r = Math.random();
      type = r < 0.25 ? CalcTypes.ADD : r < 0.5 ? CalcTypes.SUB : r < 0.75 ? CalcTypes.MUL : CalcTypes.DIV;
    }
    this.type = type;
...
var Interval = function Interval(props) {
  return _react2.default.createElement(
    "div",
    null,
    _react2.default.createElement("input", { type: "text", readOnly: true, value: props.interval }),
    _react2.default.createElement("input", { type: "range", min: 500, max: 5000, value: props.interval, style: styles.range,
      onChange: props.onChange
    })
  );
};

var CalcType = function CalcType(props) {
  return _react2.default.createElement(
    "div",
    null,
    _react2.default.createElement(
      "select",
      { onChange: props.onChange },
      Object.keys(CalcTypes).map(function (t) {
        return _react2.default.createElement(
          "option",
          { key: t, value: t },
          CalcTypes[t]
...
var NumMax = function NumMax(props) {
  return _react2.default.createElement(
    "div",
    null,
    _react2.default.createElement("input", { type: "text", value: props.numMax, value: props.numMax, onChange: props.onChange })
  );
};
...
var QA = function QA(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "span",
      { className: "a", style: { display: showAnswer ? "inline" : "none" } },
      qa.solve()
    )
  );
};
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    key: "onChangeInterval",
    value: function onChangeInterval(ev) {
      this.setState({
        interval: ev.target.value
      });
    }
  }, {
    key: "onChangeCalcType",
    value: function onChangeCalcType(ev) {
    ...
    key: "onChangeNumMax",
    value: function onChangeNumMax(ev) {
      this.setState({
    ...
    value: function newItem() {
      ...
      setTimeout(function () {
        _this2.setState({
          qa: new Item(_this2.state.calcType, _this2.state.numMax),
          showAnswer: false
        });
        _this2.newItem();
      }, this.state.interval);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          null,
          _react2.default.createElement(Interval, { interval: this.state.interval, onChange: this.onChangeInterval.bind(this) }),
          _react2.default.createElement(CalcType, { calcType: this.state.calcType, onChange: this.onChangeCalcType.bind(this) }),
          _react2.default.createElement(NumMax, { numMax: this.state.numMax, onChange: this.onChangeNumMax.bind(this) })
        ),
        _react2.default.createElement(
          "div",
          null,
          _react2.default.createElement(QA, { numMax: this.state.numMax, qa: this.state.qa, showAnswer: this.state.showAnswer })
        )
      );
    }
  }]);
...
render(_react2.default.createElement(App, null), document.querySelector("#app"));
